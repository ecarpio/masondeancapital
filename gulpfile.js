...
gulp.task('bootstrap', function() {
    return gulp.src([config.source + "/scss/bootstrap-import.scss"])
	    .pipe(sass({
            //outputStyle: 'comrpressed',
...
gulp.task('css', function() {
    return gulp.src([config.source + "/scss/styles.scss"])
	.pipe(sass({
...
// Static server
gulp.task('serve',['bootstrap', 'css' ,'compress', 'customJS', 'html'], function() {
    browserSync.init({
        server: "./"
    });
